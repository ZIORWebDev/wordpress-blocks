...
abstract class Base {
	 ...
	 */
	public function get_cache_key( string $path, array $args ): string {
	 ...
	 */
	public function get_cache( string $cache_key ): mixed {
	 ...
	 * @return void
	 */
	public function set_cache( string $cache_key, mixed $value ): void {
		$cache = Cache::get_cache_engine();
