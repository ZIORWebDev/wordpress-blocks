...
;// ./src/blocks/icon/social-list.js
/**
 * WordPress dependencies
 */
var _wp = wp,
...
function getSocialService(variation) {
  ...
  return {
    ...
    label: (_variation$title = variation === null || variation === void 0 ? void 0 : variation.title) !== null && _variation$title !== void 0 ? _variation$title : __('Social Icon')
  };
}
;// ./src/utils/hooks.js
...
var SocialLinkURLPopover = function SocialLinkURLPopover(_ref) {
  var url = _ref.url,
  ...
  return /*#__PURE__*/React.createElement(URLPopover, {
    ...
    "aria-label": edit_('Edit social link'),
...
var SocialLinkEdit = function SocialLinkEdit(_ref2) {
  ...
  var _getSocialService = getSocialService(activeVariation),
    icon = _getSocialService.icon,
    socialLinkName = _getSocialService.label;
  ...
  var socialLinkText = label.trim() === '' ? socialLinkName : label;
  var ref = edit_useRef();
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, isContentOnlyMode && showLabels &&
  /*#__PURE__*/
  ...
  }, socialLinkText)), isSelected && showURLPopover && /*#__PURE__*/React.createElement(SocialLinkURLPopover, {
    url: url,
...
var share = __webpack_require__("./node_modules/@wordpress/icons/build-module/library/share.js");
...
var edit_wp$blockEditor = wp.blockEditor,
  ...
  Inserter = edit_wp$blockEditor.Inserter,
...
var edit_wp$components = wp.components,
  ...
  Popover = edit_wp$components.Popover,
...
var _wp$components2 = wp.components,
  edit_ToolbarButton = _wp$components2.ToolbarButton,
...
function SocialLinksEdit(props) {
  ...
  var _useSelect = icon_picker_edit_useSelect(function (select) {
    ...
    hasSocialIcons = _useSelect.hasSocialIcons,
  ...
  var innerBlocksProps = useInnerBlocksProps(blockProps, {
    ...
    renderAppender: !hasSocialIcons || hasAnySelected ? edit_InnerBlocks.ButtonBlockAppender : undefined
  });
  var colorSettings = [{
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(edit_BlockControls, null, /*#__PURE__*/React.createElement(ToolbarGroup, null, /*#__PURE__*/React.createElement(edit_ToolbarButton, {
    icon: "admin-links",
    label: icon_picker_edit_('Icon'),
    onClick: function onClick() {
      return setShowAppender(true);
    }
...
function save(props) {
  ...
  return /*#__PURE__*/React.createElement("ul", innerBlocksProps);
}
